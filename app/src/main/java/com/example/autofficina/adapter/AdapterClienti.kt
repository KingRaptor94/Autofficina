...
class AdapterClienti(private val ctx: Context) : RecyclerView.Adapter<AdapterClienti.ViewHolder>() {

    private var data: List<Cliente> = mutableListOf()

    inner class ViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        private val nomeView: TextView = v.findViewById(R.id.nomeCliente)
        private val cognomeView: TextView = v.findViewById(R.id.cognomeCliente)
        private val emailView: TextView = v.findViewById(R.id.emailCliente)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(LayoutInflater.from(ctx).inflate(R.layout.cliente_singolo, parent, false))
